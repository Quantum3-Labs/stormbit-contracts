...
contract IntegrationTest is SetupTest {
    ...
    function testIntegration1() public {
        ...
        uint256 repayAmountInShares = assetManager.convertToShares(
            address(token1),
            loan.repayAmount
        );
    ...
    function testIntegration3() public {
        ...
        // check term owner balance
        // calculate repay amount in shares
        repayAmountInShares = assetManager.convertToShares(
            address(token1),
            loan.repayAmount
        );
        profitShares = repayAmountInShares - loan.sharesRequired;
        // get term weight on loan
